...
cmd = (
    "./osmosis --rbf file={input_map_file} workers=2 --buffer bufferCapacity=1000 "
    "--mapfile-writer file={output_map_file} type=hd zoom-interval-conf=13,13,13,14,14,14 threads=8 simplification-factor=0 simplification-max-zoom=20 tag-conf-file={tag_file} "
)
...
os.environ["_JAVA_OPTIONS"] = "-Xmx8g -XX:+UseStringDeduplication"
